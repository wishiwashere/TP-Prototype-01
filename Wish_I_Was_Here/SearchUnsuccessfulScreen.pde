public class SearchUnsuccessfulScreen extends Screen{
  ...
  public SearchUnsuccessfulScreen(color col){
    ...
    Icon searchTravelIcon = new Icon(appWidth * 0.3, squareIconBottomY, squareIconSize, squareIconSize, searchPageIconImage, "Search Again", true, "SearchScreen");
    Icon randomTravelIcon = new Icon(appWidth * 0.7, squareIconBottomY, squareIconSize, squareIconSize, randomPageIconImage, "Random", true, "CameraLiveViewScreen");
