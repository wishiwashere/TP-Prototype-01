...
void setup() {
  ...
  currentImage = createImage(ketaiCamera.width, ketaiCamera.height, RGB);
...
void removeGreenScreen(){
  ...
  PImage keyedImage = createImage(currentImage.width, currentImage.height, ARGB);
  ...
  for (int x = 0; x < ketaiCamera.width; x++) {
    for (int y = 0; y < ketaiCamera.height; y++) {
