public class HomeScreen extends Screen{
  ...
  public HomeScreen(color col){
    ...
    Icon searchTravelIcon = new Icon(appWidth * 0.3, appHeight * 0.4, appWidth * 0.35, appHeight * 0.08, searchPageIconImage, "Search", true, "SearchScreen");
    Icon randomTravelIcon = new Icon(appWidth * 0.7, appHeight * 0.4, appWidth * 0.35, appHeight * 0.08, randomPageIconImage, "Random", true, "CameraLiveViewScreen");
