public class SocialMediaLogoutScreen extends Screen{
  ...
  public SocialMediaLogoutScreen(color col){
    ...
    Icon noIcon = new Icon(appWidth * 0.3, iconBottomY, appWidth * 0.4, appHeight * 0.08, buttonImage, "No", true, "Middle", "SettingsScreen");
    Icon yesIcon = new Icon(appWidth * 0.7, iconBottomY, appWidth * 0.4, appHeight * 0.08, buttonImage, "Yes", true, "Middle", "SettingsScreen");
