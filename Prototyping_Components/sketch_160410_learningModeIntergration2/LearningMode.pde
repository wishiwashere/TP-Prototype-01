public class LearningMode extends Screen{
  ...
  public String favText = "Save your current location";
  public String homeText = "Return to home";
  public String shakeMovementText = "Enable movement. By tilting your phone forwards and backwards you can look up and down. Or swiping left or right you can turn around in your location";
  public String captureText = "Take a picture";
  public String switchCameraText = "Switch camera views";
