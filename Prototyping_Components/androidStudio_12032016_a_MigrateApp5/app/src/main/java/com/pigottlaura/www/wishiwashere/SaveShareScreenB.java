...
public class SaveShareScreenB extends Screen {
    ...
    public SaveShareScreenB(PApplet _p, PImage bgImage) {
        ...
        messageInput = new TextInput(p, iconCenterX, iconCenterY * 0.98, appWidth * 0.8, appHeight * 0.2, 0xFFFFFF, "messageInput", "LEFT-TOP");
        ...
        Icon cancelIcon = new Icon(p, appWidth * 0.3, iconCenterY * 1.3, appWidth * 0.4, appHeight * 0.08, buttonImage, "Cancel", true, "Middle", "SaveShareScreenA");
        ...
        Icon shareIcon = new Icon(p, appWidth * 0.7, iconCenterY * 1.3, appWidth * 0.4, appHeight * 0.08, buttonImage, "Share", true, "Middle", "_sendTweet");
