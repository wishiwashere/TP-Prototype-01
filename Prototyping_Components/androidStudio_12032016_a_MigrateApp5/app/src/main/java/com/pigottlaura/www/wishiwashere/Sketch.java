...
public class Sketch extends PApplet {
    ...
    /*-------------------------------------- Screens ------------------------------------------------*/
        ...
        myHomeScreen = new HomeScreen(this, placeholderBackgroundImage, appWidth, appHeight, homeIconSize, searchPageIconImage, randomPageIconImage, favouritesPageIconImage, aboutPageIconImage, settingsPageIconImage);
        ...
        myAboutScreen = new AboutScreen (this, loadImage("aboutScreenBackgroundImage.png"), appWidth, appHeight, iconRightX, iconTopY, iconBottomY, homeIconImage, facebookAccountIconImage, twitterAccountIconImage, instagramAccountIconImage);
    ...
    public void draw() {
        ...
        println("CAM - about to check what call function equals - " + getCallFunction());
        ...
        if (callFunction.equals("_keepImage")) {
            ...
            println("CAM - About to change current screen");
            currentScreen = "SearchingScreen";

            println("CAM - about to show searching screen");
            mySearchingScreen.showScreen();

            println("CAM - About to call getRandomLocation");
            getRandomLocation();
        } else {
            println("This function does not exist / cannot be triggered by this icon");
        }

        println("CAM - finished checking what call function equals - " + callFunction);
    ...
    void switchScreens() {
        ...
        if (currentScreen.equals("HomeScreen")) {
            ...
            myAboutScreen.showScreen(previousMouseY);
    ...
    public void setCurrentScreen(String _currentScreen){
        println("ICON Main - About to update current screen to " + _currentScreen);
        currentScreen = _currentScreen;
        println("ICON Main - Current screen now equals " + currentScreen);
    }

    public void setCallFunction(String _callFunction){
        println("CAM Main - Changing call function to " + _callFunction);
        callFunction = _callFunction;
        println("CAM Main - Call function now equals " + _callFunction);
    }
    ...
    public void setScreenTitleY(double _screenTitleY){
        // NOT WORKING
        println("ICON Main - About to update screenTitleY to " + _screenTitleY);
        screenTitleY = (float)(_screenTitleY);
        println("ICON Main - screenTitleY now equals " + screenTitleY);
    }

    void resetScreens(){
        // NOT WORKING
        println("ICON - about to reset about screen");
        myAboutScreen.resetScreen();
        println("ICON - about to reset favourites screen");
        myFavouritesScreen.resetScreen();
    }
    /*
