...
public class FavouritesScreen extends Screen {
    ...
    public Boolean favLoaded = false;
    ...
    public FavouritesScreen(PApplet _p, PImage bgImage) {
        ...
        for (int f = 0; f < favourites.length; f++) {
            ...
            FavouriteTab newFavTab = new FavouriteTab(p, favTitle, favLocation, f);
    ...
    public void showScreen() {
        ...
        if (!this.favLoaded) {
            ...
            for (int i = 0; i < favTabs.length; i++) {
                favTabs[i].setY((float)((i + 1) * appHeight * 0.25));
            }
        ...
        if (p.mousePressed) {
            ...
            float amountScrolled = dist(0, previousMouseY, 0, p.mouseY);
