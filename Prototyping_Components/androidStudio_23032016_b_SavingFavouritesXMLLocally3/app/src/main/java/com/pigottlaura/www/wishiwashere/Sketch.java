...
public class Sketch extends PApplet {
    ...
    public void setup() {
        ...
        newPath = new File("/src/main/res/xml/favourite_locations.xml");
        if (newPath.exists()) {
            println("PATH EXISTS - " + newPath);
        } else {
            println("PATH does not exist - " + newPath);
        ...
        newPath = new File(sketchPath + "/src/main/res/xml/favourite_locations.xml");
        if (newPath.exists()) {
            println("PATH EXISTS - " + newPath);
        } else {
            println("PATH does not exist - " + newPath);
        ...
        newPath = new File("/data/data/src/main/res/xml/favourite_locations.xml");
        if (newPath.exists()) {
            println("PATH EXISTS - " + newPath);
        } else {
            println("PATH does not exist - " + newPath);
        ...
        newPath = new File(dataPath("src/main/res/xml/favourite_locations.xml"));
        if (newPath.exists()) {
            println("PATH EXISTS - " + newPath);
        } else {
            println("PATH does not exist - " + newPath);
        ...
        newPath = new File(sketchPath);
        newPath = new File(newPath.getParent() + "src/main/res/xml/favourite_locations.xml");
        if (newPath.exists()) {
            println("PATH EXISTS - " + newPath);
        } else {
            println("PATH does not exist - " + newPath);
        ...
        newPath = new File(sketchPath("favourite_locations.xml"));
        if (newPath.exists()) {
            println("PATH EXISTS - sketchPath(\"favourite_locations.xml\") = " + newPath);
        } else {
            println("PATH does not exist - " + newPath);
        }
