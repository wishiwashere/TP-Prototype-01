public class SearchUnsuccessfulScreen extends Screen{
  ...
  public SearchUnsuccessfulScreen(color col){
    ...
    Icon searchTravelIcon = new Icon(appWidth * 0.3, appHeight * 0.8, appWidth * 0.35, appHeight * 0.08, searchPageIconImage, "Search Again", true, "SearchScreen");
    Icon randomTravelIcon = new Icon(appWidth * 0.7, appHeight * 0.8, appWidth * 0.35, appHeight * 0.08, randomPageIconImage, "Random", true, "CameraLiveViewScreen");
