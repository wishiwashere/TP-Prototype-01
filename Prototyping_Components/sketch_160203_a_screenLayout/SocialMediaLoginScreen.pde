public class SocialMediaLoginScreen extends Screen{
  ...
  public SocialMediaLoginScreen(color col){
    ...
    Icon cancelIcon = new Icon(appWidth * 0.3, iconBottomY, appWidth * 0.4, appHeight * 0.08, #ffffff, "Cancel", true, "CameraLiveViewScreen");
    Icon loginIcon = new Icon(appWidth * 0.7, iconBottomY, appWidth * 0.4, appHeight * 0.08, #ffffff, "Login", true, "CameraLiveViewScreen");
