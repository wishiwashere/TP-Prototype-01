public class SharingScreen extends Screen{
  ...
  public SharingScreen(color col){
    ...
    sharingImage = loadImage("placeholder.PNG");
  ...
  public void showScreen(){
    ...
    this.addImage(sharingImage, appWidth/2, appHeight/2, appWidth * 0.8, appWidth * 0.4);
  }
}