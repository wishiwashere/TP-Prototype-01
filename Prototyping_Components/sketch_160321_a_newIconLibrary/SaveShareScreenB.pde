public class SaveShareScreenB extends Screen {
  ...
  public SaveShareScreenB(PImage bgImage) {
    ...
    Icon cancelIcon = new Icon(appWidth * 0.2, iconCenterY * 1.3, appWidth * 0.2, appHeight * 0.1, previousButtonImage, "", true, "Middle", "SaveShareScreenA");
    ...
    Icon shareIcon = new Icon(appWidth * 0.8, iconCenterY * 1.3, appWidth * 0.2, appHeight * 0.1, nextButtonImage, "", true, "Middle", "_sendTweet");
