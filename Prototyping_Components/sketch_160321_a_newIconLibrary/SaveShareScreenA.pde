public class SaveShareScreenA extends Screen {
  ...
  public SaveShareScreenA(PImage bgImage) {
    ...
    Icon cancelIcon = new Icon(appWidth * 0.2, iconBottomY, appWidth * 0.15, appHeight * 0.1, previousButtonImage, "", true, "Middle", "CameraLiveViewScreen");
    Icon nextIcon = new Icon(appWidth * 0.8, iconBottomY, appWidth * 0.15, appHeight * 0.1, nextButtonImage, "", true, "Middle", "SaveShareScreenB"); 
