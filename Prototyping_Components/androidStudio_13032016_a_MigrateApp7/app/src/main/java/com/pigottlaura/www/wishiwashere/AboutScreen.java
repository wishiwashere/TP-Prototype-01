...
public class AboutScreen extends Screen {
    ...
    public AboutScreen(PApplet _p, PImage bgImage) {

        // Passing the color parametre to the super class (Screen), which will in
        // turn call it's super class (Rectangle) and create a rectangle with the
        // default values i.e. fullscreen, centered etc.
        super(_p, _p.width/2, _p.height/2, _p.width, _p.height * 2, _p.loadImage("aboutScreenBackgroundImage.png"));
        ...
        //Icon emailIcon = new Icon(p, appWidth * 0.8, iconBottomY, emailIconImage, "Email", false, "mailto:wishiwashere.thenopayholiday@gmail.com");
