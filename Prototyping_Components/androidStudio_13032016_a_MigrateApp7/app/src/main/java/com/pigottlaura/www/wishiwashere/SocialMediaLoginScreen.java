...
public class SocialMediaLoginScreen extends Screen {
    ...
    public SocialMediaLoginScreen(PApplet _p, PImage bgImage) {
        ...
        Icon cancelIcon = new Icon(p, appWidth * 0.3, iconCenterY * 1.2, appWidth * 0.4, appHeight * 0.08, buttonImage, "Cancel", true, "Middle", "-returnTo");
        Icon loginIcon = new Icon(p, appWidth * 0.7, iconCenterY * 1.2, appWidth * 0.4, appHeight * 0.08, buttonImage, "Login", true, "Middle", "-returnTo");
        ...
        usernameInput = new TextInput(p, iconCenterX, iconCenterY * 0.55, appWidth * 0.8, appHeight * 0.08, 0xFFFFFF, "usernameInput");
        passwordInput = new TextInput(p, iconCenterX, iconCenterY * 0.95, appWidth * 0.8, appHeight * 0.08, 0xFFFFFF, "passwordInput", true);
    }
