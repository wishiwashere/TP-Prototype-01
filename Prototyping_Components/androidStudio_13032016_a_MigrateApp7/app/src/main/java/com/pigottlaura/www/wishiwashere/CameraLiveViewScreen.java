...
public class CameraLiveViewScreen extends Screen {
    ...
    public CameraLiveViewScreen(PApplet _p) {
        ...
        Icon homeIcon = new Icon(p, iconRightX, iconTopY, homeIconImageWhite, "Home", false, "HomeScreen");
        Icon favIcon = new Icon(p, iconLeftX, iconTopY, favIconImage, "Add to Favourites", false, "_addToFavourites");
        Icon shakeIcon = new Icon(p, iconLeftX, iconBottomY, shakeIconImage, "Turn on/off Shake", false);
        Icon shutterIcon = new Icon(p, iconCenterX, iconBottomY, shutterIconImage, "Take a Picture", false, "_mergeImages");
        Icon switchViewIcon = new Icon(p, iconRightX, iconBottomY, switchViewIconImage, "Switch View", false, "_switchCameraView");
    ...
    public void showScreen() {
        ...
        if (p.mousePressed) {
            ...
            float amountScrolledX = dist(0, previousMouseX, 0, p.mouseX);
            float amountScrolledY = dist(0, previousMouseY, 0, p.mouseY);
            ...
            if (previousMouseX > mouseX) {
                ...
                p.println("scrolled right. heading is now " + googleImageHeading);
            } else {
                ...
                p.println("scrolled left. heading is now " + googleImageHeading);
            }

            p.println("amountScrolledY = " + amountScrolledY);
            if (previousMouseY > p.mouseY) {
                ...
                googleImagePitch = (googleImagePitch + amountScrolledY) > 90 ? 90 : googleImagePitch + amountScrolledY;
                p.println("scrolled down. pitch is now " + googleImagePitch);
            }
        ...
        p.image(currentLocationImage, appWidth/2, appHeight/2, appWidth, appHeight);
