...
public class SearchScreen extends Screen {
    ...
    public SearchScreen(PApplet _p, PImage bgImage) {
        ...
        searchInput = new TextInput(p, iconCenterX, iconCenterY * 0.7, appWidth * 0.8, appHeight * 0.3, 0xFFFFFF, "searchInput", "LEFT-TOP");
        ...
        Icon cancelIcon = new Icon(p, appWidth * 0.3, iconCenterY * 1.1, appWidth * 0.4, appHeight * 0.08, buttonImage, "Cancel", true, "Middle", "HomeScreen");
        Icon searchIcon = new Icon(p, appWidth * 0.7, iconCenterY * 1.1, appWidth * 0.4, appHeight * 0.08, buttonImage, "Search", true, "Middle", "_searchForLocation");
