...
public class Rectangle extends Sketch {
  ...
  /*-------------------------------------- Constructor() ------------------------------------------------*/
    ...
    protected Rectangle(PApplet _p, double x, double y, double w, double h, int col, PImage img) {
        ...
        rectCol = p.color(col);
        rectImage = img;
        println("homeIconSize now :) in Rectangle = " + homeIconSize);
    }
  ...
  /*-------------------------------------- show() ------------------------------------------------*/
    ...
    protected void show() {
        ...
        p.println("Completed showing the rectangle");
    }
  ...
  /*-------------------------------------- addText() ------------------------------------------------*/
    ...
    protected void addText(String text, double textX, double textY, double textSize) {
        ...
        p.println("In rect class - in addText constructor screen");
    ...
    protected void addText(String text, String align, double textX, double textY, double textSize) {
        ...
        p.println("In rect class - in addText method screen");
        // Storing the current state of the matrix
        p.pushMatrix();
        ...
        p.println("In rect class - about to change text align screen");
        ...
        p.println("In rect class - about to change text size screen " + (float)(textSize));
        // Setting the text size to be responsive to the height of the app
        p.textSize((float)(textSize));

        p.println("In rect class - about to change text color screen");
        // Setting the fill color for the text to black
        p.fill(0);

        p.println("In rect class - about to add text to screen");
  ...
  /*-------------------------------------- get() and set() ------------------------------------------------*/
    ...
    public float getWidth() {
        p.println("About to return width " + rectWidth);
        return rectWidth;
    }
