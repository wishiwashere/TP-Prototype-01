...
public class ShareSaveUnsuccessfulScreen extends Screen {
    ...
    public ShareSaveUnsuccessfulScreen(PApplet _p, PImage bgImage) {
        ...
        Icon retryIcon = new Icon(p, iconCenterX, largeIconBottomY * 0.75, largeIconSize, largeIconSize, retryIconImage, "Retry", true, "Below", "_sendTweet");
        Icon deleteIcon = new Icon(p, iconCenterX * 0.55, largeIconBottomY, largeIconSize, largeIconSize, deleteIconImage, "Delete", true, "Below", "CameraLiveViewScreen");
        Icon saveIcon = new Icon(p, iconCenterX * 1.45, largeIconBottomY, largeIconSize, largeIconSize, saveIconImage, "Save", true, "Below", "ShareSaveSuccessfulScreen");
    ...
    public void showScreen() {
        ...
        this.addImage(loadImage("shareSaveUnsuccessfulScreenImage.png"), iconCenterX, appHeight * 0.4, appWidth * 0.5, appHeight * 0.16);
    }
}