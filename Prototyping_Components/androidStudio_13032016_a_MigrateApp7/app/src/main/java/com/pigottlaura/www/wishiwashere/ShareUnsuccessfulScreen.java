...
public class ShareUnsuccessfulScreen extends Screen {
    ...
    public ShareUnsuccessfulScreen(PApplet _p, PImage bgImage) {
        ...
        Icon cancelIcon = new Icon(p, iconCenterX * 0.55, largeIconBottomY, largeIconSize, largeIconSize, cancelIconImage, "Cancel", true, "Below", "CameraLiveViewScreen");
        Icon retryIcon = new Icon(p, iconCenterX * 1.45, largeIconBottomY, largeIconSize, largeIconSize, retryIconImage, "Retry", true, "Below", "_sendTweet");
