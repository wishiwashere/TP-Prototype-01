...
public class ImagePreviewScreen extends Screen {
    ...
    public ImagePreviewScreen(PApplet _p) {
        ...
        Icon disgardIcon = new Icon(p, iconLeftX, iconBottomY, disgardIconImage, "Disgard Image", false, "_disgardImage");
        Icon keepIcon = new Icon(p, iconRightX, iconBottomY, keepIconImage, "Keep Image", false, "_keepImage");
    ...
    public void showScreen() {
        p.image(compiledImage, appWidth/2, appHeight/2, appWidth, appHeight);
