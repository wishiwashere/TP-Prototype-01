...
public class Icon extends ClickableElement {
  ...
  /*-------------------------------------- showIcon() ------------------------------------------------*/
    ...
    public void showIcon() {
        p.println("About to show rectangle of screen icon");
        ...
        if (showIconTitle)
        {
            p.println("About to add text to screen icon");
            ...
            if (iconTitlePosition.equals("Middle")) {
                p.println("About to call addText on screen icon " + getWidth());
                ...
                p.println("No title to add to screen");
            }
            p.println("Added text to screen icon");
        }
        p.println("About to check if mouse over icon");
        if (p.mousePressed) {
            if (this.checkMouseOver()) {
                ...
                if (this.iconLinkTo.length() > 0)
                {
                    ...
                    if (this.iconLinkTo.indexOf("http") > -1)
                    {
                        ...
                        screenTitleY = (float)(appHeight * 0.08);
