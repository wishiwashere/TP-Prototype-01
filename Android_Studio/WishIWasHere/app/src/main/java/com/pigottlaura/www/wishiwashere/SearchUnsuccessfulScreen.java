...
public class SearchUnsuccessfulScreen extends Screen {
    ...
    public SearchUnsuccessfulScreen(PApplet _p, PImage bgImage) {
        ...
        Icon searchTravelIcon = new Icon(p, appWidth * 0.3, largeIconBottomY, largeIconSize, largeIconSize, searchPageIconImage, "Search Again", true, "Below", "SearchScreen");
        Icon randomTravelIcon = new Icon(p, appWidth * 0.7, largeIconBottomY, largeIconSize, largeIconSize, randomPageIconImage, "Random", true, "Below", "_getRandomLocation");
