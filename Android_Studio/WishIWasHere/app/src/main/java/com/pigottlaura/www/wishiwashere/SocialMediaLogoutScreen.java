...
public class SocialMediaLogoutScreen extends Screen{
    ...
    public SocialMediaLogoutScreen(PApplet _p, PImage bgImage){
        ...
        Icon noIcon = new Icon(p, appWidth * 0.3, iconBottomY, appWidth * 0.4, appHeight * 0.08, buttonImage, "No", true, "Middle", "SettingsScreen");
        Icon yesIcon = new Icon(p, appWidth * 0.7, iconBottomY, appWidth * 0.4, appHeight * 0.08, buttonImage, "Yes", true, "Middle", "SettingsScreen");
