...
public class SaveShareScreenA extends Screen {
    ...
    public SaveShareScreenA(PApplet _p, PImage bgImage) {
        ...
        Icon instagramIcon = new Icon(p, iconCenterX * 0.55, iconCenterY, largeIconSize, largeIconSize, instagramAccountIconImage, "Instagram", true, "Below", "SocialMediaLoginScreen");
        Icon twitterIcon = new Icon(p, iconCenterX * 1.45, iconCenterY, largeIconSize, largeIconSize, twitterAccountIconImage, "Twitter", true, "Below", "SocialMediaLoginScreen");
        Icon saveIcon = new Icon(p, iconCenterX, iconCenterY * 1.5, largeIconSize, largeIconSize, saveIconImage, "Save", true, "Below", "_keepImage");
        Icon cancelIcon = new Icon(p, appWidth * 0.3, iconBottomY, appWidth * 0.4, appHeight * 0.08, buttonImage, "Cancel", true, "Middle", "CameraLiveViewScreen");
        Icon nextIcon = new Icon(p, appWidth * 0.7, iconBottomY, appWidth * 0.4, appHeight * 0.08, buttonImage, "Next", true, "Middle", "SaveShareScreenB");
