...
public class SaveShareScreenA extends Screen {
    ...
    public SaveShareScreenA(Sketch _sketch, PImage bgImage) {
        ...
        Icon twitterIcon = new Icon(sketch, sketch.iconCenterX * 1.45, sketch.iconCenterY, sketch.largeIconSize, sketch.largeIconSize, sketch.twitterAccountIconImage, "Twitter", true, "Below", "SocialMediaLoginScreen");
