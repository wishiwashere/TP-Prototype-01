...
public class SettingsScreen extends Screen {
    ...
    public SettingsScreen(PApplet _p, PImage bgImage) {
        ...
        Icon learningModeIcon = new Icon(p, iconRightX * 0.9, iconCenterY * 0.5, smallIconSize * 1.8, smallIconSize * 0.9, toggleSwitchOffIconImage, "Learning mode switch", false, "_switchLearningMode");
        Icon autoSaveIcon = new Icon(p, iconRightX * 0.9, iconCenterY * 0.8, smallIconSize * 1.8, smallIconSize * 0.9, toggleSwitchOnIconImage, "Auto-save switch", false, "_switchAutoSave");
        Icon instagramAccountIcon = new Icon(p, iconCenterX * 0.55, iconCenterY * 1.2, largeIconSize, largeIconSize, instagramAccountIconImage, "Instagram", true, "Below", "SocialMediaLoginScreen");
        Icon twitterAccountIcon = new Icon(p, iconCenterX * 1.45, iconCenterY * 1.2, largeIconSize, largeIconSize, twitterAccountIconImage, "Home", true, "Below", "SocialMediaLoginScreen");
